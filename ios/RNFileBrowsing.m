...
#import "RNFileBrowsing.h"
#import <UIKit/UIKit.h>
#import <QuartzCore/QuartzCore.h>
#import <AVFoundation/AVFoundation.h>
#import <AVKit/AVKit.h>
#import "QLCustomPreviewItem.h"
@implementation RNFileBrowsing
CGFloat prog;
 ...
 * Parameters: NSArray
 */
RCT_EXPORT_METHOD(show:(NSString *)strUrl fileName:(NSString *)fileName)
{
    __weak RNFileBrowsing* weakSelf = self;
...
//        [dat writeToURL:tmpFileUrl atomically:YES];
        ...
        NSURL* tmpFileUrl = [[NSURL alloc] initFileURLWithPath:strUrl];
        self.fileUrl = tmpFileUrl;
        self.optionalFileName = fileName;
    }
